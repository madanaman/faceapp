...
- Experimental Intel Mac x64 DMG builds are generated by GitHub Actions. I do not currently have an Intel Mac to validate them, so please treat Intel builds as community-test candidates and report feedback.
